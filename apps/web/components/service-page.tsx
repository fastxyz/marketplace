          ...
          <div className="grid gap-6 xl:grid-cols-[1.08fr_0.92fr] xl:items-start">
            <div className="page-stack">
              ...
              <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                {isMarketplaceService ? (
                  <>
                    <StatCard label="Total Calls" value={String(service.summary.totalCalls)} icon={<Sparkle className="size-4" />} />
                    <StatCard label="Revenue" value={`$${service.summary.revenue}`} icon={<DatabaseZap className="size-4" />} />
                    <StatCard label="Endpoints" value={String(service.summary.endpointCount)} icon={<ArrowLeftRight className="size-4" />} />
                    <StatCard
                      label="Success Rate"
                  ...
                  <>
                    <StatCard label="Endpoints" value={String(service.summary.endpointCount)} icon={<ArrowLeftRight className="size-4" />} />
                    <StatCard label="Access" value="Direct API" icon={<Sparkle className="size-4" />} />
                    <StatCard
                      label="Website"
                      value={service.websiteUrl ? new URL(service.websiteUrl).hostname : "Not set"}
            ...
            {isMarketplaceService ? (
              <Card>
                <CardHeader>
                  ...
                  <CardTitle>Marketplace call flow over time</CardTitle>
